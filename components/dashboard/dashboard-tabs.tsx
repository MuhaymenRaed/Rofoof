...
import { Bag, Package, Grid, Sparkles, Star, Refresh } from "@/components/icons";
...
const TABS: { href: string; key: DictKey; icon: React.ReactNode }[] = [
  ...
  { href: "/dashboard/restock", key: "dash.restock", icon: <Refresh size={16} /> },
  { href: "/dashboard/featured", key: "dash.featured", icon: <Star size={16} /> },
